...
- **[DECISION] Porcja mięsa = 200 g/osobę; danie = `base_servings` × 200 g.** Gotujemy dla 1 + 0,5 + 0,5 = 2 porcje, więc standardowe danie mięsne = **400 g** (nie 200 g — wcześniejsza wersja była błędna). Karty zaktualizowane: łosoś/schab/kebab/pulpeciki/kotlety/sos liczą 400 g mięsa na `base_servings: 2` (+ proporcjonalnie jajka, bułka, passata). Dzieci jedzą łącznie ~0,5–0,75 porcji (ciężko dzielić przy gotowaniu) → naturalna nadwyżka trafia do lodówki/zamrażarki, nie do dokładnego dzielenia.
