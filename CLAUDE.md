...
- **Zamrażarka:** gospodarstwo ma zamrażarkę (trwale), ale status bieżący sprawdzaj w `preferences.md`. Gdy **W NAPRAWIE / niedostępna** — nie planuj mrożenia: nadwyżki → lodówka + `leftovers` w journalu / slot „z lodówki", a mielone na 2 dania (kotlety + sos) gotuj tego samego dnia (reguła warunkowa). Gdy dostępna — mrożenie i rozprzężenie sosu w czasie są ok.
