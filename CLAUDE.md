...
- Karty przepisów: MD + frontmatter YAML wg wzorca z `recipes/`. `base_servings: 2` (przelicznik: dorosły = 1, dziecko = 0,5). Jedna wersja dania dla wszystkich — bez wariantów per osoba.
